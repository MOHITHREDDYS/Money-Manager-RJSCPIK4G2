...
const MoneyDetails = props => {
  ...
  return (
    <>
      <li className="background_properties1 amounts_container">
        <img
      ...
      <li className="background_properties2 amounts_container">
        <img
      ...
      <li className="background_properties3 amounts_container">
        <img
